...
void fieldDivTwoExpResolve(Field *r, Field *a, int32_t exp) {
    ...
    shifter[0 + words] = a->f0 << bits;
    shifter[1 + words] = a->f1 << bits;
    shifter[2 + words] = a->f2 << bits;
    shifter[3 + words] = a->f3 << bits;
    shifter[4 + words] = a->f4 << bits;
    shifter[5 + words] = a->f5 << bits;
    shifter[6 + words] = a->f6 << bits;
    shifter[7 + words] = a->f7 << bits;
    shifter[8 + words] = a->f8 << bits;
    shifter[9 + words] = a->f9 << bits;
    shifter[10 + words] = a->f10 << bits;
    shifter[11 + words] = a->f11 << bits;
