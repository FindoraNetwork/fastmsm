...
packedFieldMultiplySubtract(PackedField *T, PackedField *U, Coeffs c, PackedField *A, PackedField *B) {
    int64_t tAcc, uAcc;
...
static inline uint64_t
packedFieldMultiplyAdd(PackedField *T, PackedField *U, Coeffs c, PackedField *A, PackedField *B) {
    int64_t tAcc, uAcc;
    uint64_t al, ah, bl, bh, m = 0xFFFFFFFFull;
    uint64_t tl, ul;
